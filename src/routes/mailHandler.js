...
router.post(`/send/signaturePetition/`, (req, res) => {
  ...
  const html = `<h1>¡Hola!</h1><br><br/><p>${from} te ha enviado esta boleta para ser firmada, hacé click en <a href='https://billsapp.herokuapp.com/offlinesignature/${invoiceId}'>este link</a> para ir</p><p>En caso de que no hayas estado esperando este mail, Es mejor ignorarlo.`;
