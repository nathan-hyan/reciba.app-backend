...
router.post(`/send/signaturePetition/`, (req, res) => {
  ...
  const html = `<h1>¡Hola!</h1><br><br/><p><b>${from}</b> te ha enviado esta boleta para ser firmada, hacé click en <a href='https://reciba.app/#/offlinesignature/${invoiceId}'>este link</a> para ir</p><p>En caso de que no hayas estado esperando este mail, Es mejor ignorarlo.`;
