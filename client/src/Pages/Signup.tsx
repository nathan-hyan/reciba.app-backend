        ...
        <Container>
            <Row className='h-100-minus align-items-center'>
                <Col>
                    ...
                    <p className="lead">Lorem ipsum dolor sit, amet consectetur adipisicing elit. At, nisi. Provident ipsum praesentium numquam sapiente.</p>
                </Col>
                <Col className='bg-light shadow p-3 rounded'>
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control type="email" name='email' onChange={handleChange} value={state.email}
                                required />
                        ...
                        <Row>
                            <Col>
                                <Form.Group>
                                    ...
                                    <Form.Control type="password" name='password' onChange={handleChange} value={state.password} required />
                            ...
                            <Col>
                                <Form.Group>
                                    ...
                                    <Form.Control type="password" name='repeatPassword' onChange={handleChange} value={state.repeatPassword} required />
                                    <Form.Control.Feedback type="invalid">Please check if both password are the same.</Form.Control.Feedback>

                                </Form.Group>
                            </Col>
                        </Row>

                        <Button variant="primary" type="submit"><FontAwesomeIcon icon={faCheck} /> Sign up!</Button>
                    </Form>
                </Col>
            </Row>
        </Container>
